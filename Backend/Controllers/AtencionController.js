...
export default {
  ...
  // Método para actualizar los detalles de una venta y el cliente si es necesario
  actualizarDetallesVenta(atencionId, detalles, clienteId = null) {
    const payload = {
      detalles: detalles,
      clienteId: clienteId
    };
  ...
  eliminarVenta(atencionId) {
    console.log(`Eliminando venta con ID: ${atencionId}`);
    return apiClient.delete(`/atencion/${atencionId}`);
  },
};